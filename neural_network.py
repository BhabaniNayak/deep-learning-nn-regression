...
##########################################################
iterations = 6000 # 100, 1000, 2000, 5000, 6000, 10000
learning_rate = 0.4 # 0.1, 0.2 Increasing the learning rate, decreases the loss below 0.1
hidden_nodes = 10 # 2, 5, 10
output_nodes = 1
